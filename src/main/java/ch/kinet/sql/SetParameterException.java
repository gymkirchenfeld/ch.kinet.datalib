...
public class SetParameterException extends SqlException {

    SetParameterException(Property property, Throwable cause) {
        super(buildMessage(property, cause), cause);
    }

    private static String buildMessage(Property property, Throwable cause) {
        final StringBuilder result = new StringBuilder();
        result.append("Error while setting parameter '");
