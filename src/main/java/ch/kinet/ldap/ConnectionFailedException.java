...
public class ConnectionFailedException extends LdapException {

    ConnectionFailedException(LdapSpec spec, Throwable cause) {
        super(buildMessage(spec, cause), cause);
    }
