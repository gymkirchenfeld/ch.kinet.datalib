...
public class OperationFailedException extends LdapException {

    OperationFailedException(String operation, Name dn, Throwable cause) {
        super(buildMessage(operation, dn, cause), cause);
    }
